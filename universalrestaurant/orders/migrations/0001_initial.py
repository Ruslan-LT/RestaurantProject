# Generated by Django 5.2 on 2025-05-17 09:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_address', models.TextField(blank=True, null=True, verbose_name='Адресса доставки')),
                ...
                ('user', models.ForeignKey(default=None, on_delete=django.db.models.deletion.SET_DEFAULT, to=settings.AUTH_USER_MODEL, verbose_name='Користувач')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dish', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='dishes.dishes', verbose_name='Страва')),
